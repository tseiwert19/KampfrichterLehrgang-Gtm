...
public class SearchResultPanel extends CenterPanel {
	...
	private static final String[] GERAETE = { "Alle Geräte anzeigen", "Boden",
			"Pauschenpferd", "Ringe", "Sprung", "Barren", "Reck" };
	 ...
	 * 
	 * @param name
	 *            Es wird ein Video gesucht, das diesen Teilstring enthaelt
	 */
	...
	private void createGeraetePanel(String geraeteName) {
		...
		JLabel label = new JLabel("<html><font size='8'><b><i>" + geraeteName
				+ "</b></i></font>");
		label.setVerticalAlignment(JLabel.CENTER);
		label.setHorizontalAlignment(JLabel.CENTER);
		geraetePanel.add(label);
		KariButton pdfButton = new KariButton(
				"<html><font size='5'><b>Informationen zur D-Note</b></font></html>");
	 ...
	 * 
	 * @param videos
	 *            Liste der Videos von einem Geraet
	 */
	...
	private String createHtmlString(Video video) {
		return "<html><center><font size='5'><b><i>"
				+ kuerzeString(video.getName())
				+ " </b></i></font><br> Schwierigkeitsgrad: "
				+ video.getSchwierigkeitsgrad() + "<br> Elementgruppe: "
				+ video.getElementgruppe() + "  </center></html>";
	}
	...
	/**
	 * Kuerzt einen String. Namen der Videos sind fuer die Buttons zu gross,
	 * deswegen werden sie gekuerzt.
	 * 
	 * @param string
