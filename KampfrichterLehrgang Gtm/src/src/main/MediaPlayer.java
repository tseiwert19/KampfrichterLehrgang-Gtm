...
class PauseIcon implements Icon{
	...
	public void paintIcon(Component c, Graphics g, int x, int y) {
		...
		g2d.fillRect(x+3*width/4,y+2,(3*width/4)-(width/6),height-2);
...
public class MediaPlayer extends JPanel
{
	...
	private ResourceBundle localeBundle=ResourceBundle.getBundle("src.main.localization.MediaPlayer");
	...
	MediaPlayer(String mediaURL)
	{
		...
		ourMediaPlayer=new EmbeddedMediaPlayerComponent()
		{
			...
			/*
        ourMediaPlayer.getMediaPlayer().addMediaPlayerEventListener(new MediaPlayerEventAdapter() {
			public void playing(MediaPlayer mediaPlayer) {
				pauseButton.setText(pauseButtonLabel);
				pauseButton.setIcon(pauseIcon);
				System.out.println("playing()");
		...
		//TODO: exception
		playIcon=new ImageIcon(getClass().getResource("icons/control_play_blue.png"));
		pauseIcon=new ImageIcon(getClass().getResource("icons/control_pause_blue.png"));
		...
		repeatButton=new JToggleButton(repeatButtonLabel, ourMediaPlayer.getMediaPlayer().getRepeat());
		repeatButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				boolean repeatState=ourMediaPlayer.getMediaPlayer().getRepeat();
        ...
        fullScreenButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
				...
				GraphicsEnvironment.getLocalGraphicsEnvironment().getDefaultScreenDevice().setFullScreenWindow((JFrame)SwingUtilities.getWindowAncestor(this));
            }
        });
